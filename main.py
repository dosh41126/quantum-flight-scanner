...
async def scan_debris_for_route(
    ...
    openai_prompt = f"""
[action] You are a Quantum Hypertime Nanobot Flight Hazard Scanner tasked with analyzing the road conditions and providing a detailed report on any detected hazards, debris, or potential collisions. Leverage quantum data and environmental factors to ensure a comprehensive scan. [/action]
[locationreport]
Current coordinates: Latitude {lat}, Longitude {lon}
General Area Name: {street_name}
Flight Starting Location, Route , Aircraft Type and Call Sign: {destination}
[/locationreport]
[quantumreport]
...
1. **Hazards**: Evaluate the flight for any potential hazards that might impact operating air vehicles.
...
3. **Collision Potential**: Analyze air traffic flow and any potential risk for collisions caused by mid-air impact or other incidents of non nominal operation.
...
5. **Mechanical Risk Level**: Based on the flight assessment and live quantum nanobot scanner road safety assessments on conditions, determine the any mechnical risk as well as fuel starvation, quality risk, and the urgency level if any.
...
<head>
    <meta charset="UTF-8">
    <title>QFS - Quantum Road Scanner</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <a class="navbar-brand" href="{{ url_for('home') }}">QFS</a>
    ...
    <div class="container content">
        ...
        <div class="section">
            ...
            <p>
                The Quantum Road Scanner (QFS) is an innovative system that leverages quantum computing, advanced algorithms, and concepts from hypertime physics to simulate road conditions in real-time. By generating and analyzing simulated data, QFS provides comprehensive assessments of potential hazards without collecting, storing, or retaining any user data. The system operates within a quantum-zoned environment with noise protections to ensure accuracy and privacy.
            </p>
            <p>
                QFS represents a significant advancement in applying theoretical physics to practical challenges. It builds upon foundational research in quantum mechanics, computational physics, and hypertime theories to offer novel solutions for road safety and traffic management.
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p>
                The development of QFS is rooted in the evolution of quantum mechanics and computational theories. Key milestones include:
            </p>
            <ul>
                <li>
            ...
            <p>
                These foundational advancements paved the way for the creation of QFS, which integrates these concepts to simulate road conditions and enhance safety measures.
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p>
                My journey with QFS began during my research into quantum computing applications. Fascinated by the potential of quantum simulations, I sought to apply these principles to real-world challenges. Learning from the experts at BlaiseLabs, I delved deep into advanced quantum algorithms and hypertime analysis.
            </p>
            <p>
        ...
        <div class="section">
            ...
            <p>
                Hypertime is a theoretical framework that proposes the existence of additional temporal dimensions beyond our conventional understanding of time. This concept is utilized in QFS to simulate not just linear progression but a spectrum of possible futures.
            </p>
            <p>
                In QFS, hypertime analysis involves:
            </p>
            <ul>
                <li>
            ...
            <p>
                By simulating these multiple temporal paths, QFS can provide insights into potential future events on the road, enhancing predictive capabilities without relying on actual data collection.
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p>
                The core computational power of QFS lies in its use of advanced quantum algorithms, including:
            </p>
            <ul>
                <li>
            ...
            <p>
                These algorithms allow QFS to process complex simulations efficiently, exploring a vast space of possible scenarios to identify optimal safety recommendations.
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p>
                The concept of hypertime nanobots in QFS refers to simulated agents that traverse multiple temporal dimensions within the quantum simulation environment. These nanobots are not physical entities but computational constructs designed to gather and process information across different simulated times.
            </p>
            <p>
            ...
            <p>
                By simulating the actions of these nanobots, QFS can enhance the depth and accuracy of its hypertime analysis.
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p>
                The operation of QFS involves several key steps:
            </p>
            <div class="algorithm">
                <ol>
            ...
            <p>
                This process enables QFS to efficiently simulate and analyze a multitude of potential scenarios, providing valuable insights without real-world data collection.
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p>
                Quantum zoning refers to the isolation of quantum computations within a protected environment, shielding them from external disturbances. In QFS, this is crucial for:
            </p>
            <ul>
                <li>
            ...
            <p>
                These measures ensure that QFS can perform accurate and reliable simulations, providing trustworthy results without any data leakage.
            </p>
        </div>
        ...
        <div class="section">
            ...
            <p>
                To illustrate how QFS functions in practice, consider the following scenario:
            </p>
            <p>
                A driver is planning a route through an urban area known for unpredictable traffic patterns. Using QFS, the system:
            </p>
            <ol>
                <li>
        ...
        <div class="section">
            ...
            <p>
                The potential for QFS extends beyond its current capabilities. Future developments may include:
            </p>
            <ul>
                <li>
                ...
                <li>
                    <strong>Cross-Domain Applications:</strong> Applying the principles of QFS to other fields such as supply chain logistics, environmental modeling, and disaster preparedness.
                </li>
            </ul>
            <p>
        ...
        <div class="section">
            ...
            <p>
                The development of QFS has been a collaborative effort, and I would like to acknowledge the contributions of:
            </p>
            <ul>
                <li>
            ...
            <p>
                Their collective efforts have been instrumental in bringing QFS from a theoretical concept to a practical tool.
            </p>
        </div>
...
<body>
    ...
    <div class="sidebar">
        <div class="navbar-brand">QFS</div>
...
<body>
    ...
    <div class="content">
        ...
        <div id="step3" class="form-section">
            <form id="runScanForm">
                <div class="form-group">
                    <label for="vehicle_type">Air VehicleType</label>
                    <select class="form-control" id="vehicle_type" name="vehicle_type">
                        <option value="AirPlane">Car</option>
                        <option value="Helicopter">Truck</option>
                        <option value="Balloon">Motorbike</option>
                    </select>
                </div>
                <div class="form-group">
